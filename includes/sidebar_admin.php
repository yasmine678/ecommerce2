<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-primary" style="width: 250px; min-height: 100vh; position: fixed; top: 0; left: 0; z-index: 1000;">
    <!-- Logo -->
    ...
    <ul class="nav nav-pills flex-column mb-auto gap-1">
        ...
        <li>
            <a href="../categories/index_admin.php" class="nav-link text-white d-flex align-items-center gap-2">
        ...
        <li>
            <a href="../products/index_admin.php" class="nav-link text-white d-flex align-items-center gap-2">
        ...
        <li>
            <a href="../orders/index.php" class="nav-link text-white d-flex align-items-center gap-2">
